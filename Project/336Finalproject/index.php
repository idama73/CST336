...
<html>
    ...
    <div class='container'>
        <div class='text-center'>
            ...
            <nav class='navbar navbar-default - navbar-fixed-top'>
                <div class='container-fluid'>
                    <div class='navbar-header'>
                        <a class='navbar-brand' href='#'>Zama's Play-Store</a>
                    </div>
            ...
            <div class="filters">
                <h2>
                    Search for Games Below
                </h2>
                <form>
                    Search: 
                    <input type="text" name="product"/> <br>
                    
                    Price Start:<input type="number" name = "priceStart" id="priceStart" Min="0" Max="500" ></input>
                    Price End: <input type="number" name = "priceEnd" id="priceEnd" Min="0" Max="500" ></input><br>
