        ...
        <div class='text-center'>
            ...
            <div class="filters">
                ...
                <form>
                    ...
                    Price start:<input type="number" id="priceFrom" Min="0" Max="500" value="0"></input>
                    Price end: <input type="number" id="priceTo" Min="0" Max="500" value="500"></input><br>
